...
const Classes = () => {
    ...
    const fetchRoutine = async () => {
        try {
            const { data } = await axios.get(`http://localhost:5000/api/routines/${selectedClass}`, {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://localhost:5000/api/routines', { ...formData, class: selectedClass }, {
                headers: {
